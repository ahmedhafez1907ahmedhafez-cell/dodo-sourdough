...
export async function recalcItems(adminDb, rawItems) {
  ...
  for (const raw of rawItems) {
    ...
    let totalPrice, qty, extras = [], extrasPrice = 0, basePrice, grams = 0;
    ...
    items.push({
      ...
      grams: p.isStarter ? grams : 0,         // وزن الخميرة بالجرام — بيتحسب بيه سعر "الكيلو الزيادة"
